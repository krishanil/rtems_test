...
#include <bsp/core_cmInstr.h>                /*!< Core Instruction Access                         */
#include <bsp/core_cmFunc.h>                 /*!< Core Function Access                            */
#include <bsp/core_cm4_simd.h>               /*!< Compiler specific SIMD Intrinsics               */
